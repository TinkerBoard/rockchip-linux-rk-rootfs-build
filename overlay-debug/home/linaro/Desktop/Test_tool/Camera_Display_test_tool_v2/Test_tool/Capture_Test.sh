...
cat /sys/bus/i2c/drivers/imx219/2-0010/name |grep "imx219"
if [ "$?" == "0" ]; then
	...
	media-ctl -d /dev/media0 --set-v4l2 '"m00_b_imx219 2-0010":0[fmt:SRGGB10_1X10/3280x2464]'
	...
	media-ctl -d /dev/media0 --set-v4l2 '"m00_b_ov5647 2-0036":0[fmt:SBGGR8_1X8/2592x1944]'
