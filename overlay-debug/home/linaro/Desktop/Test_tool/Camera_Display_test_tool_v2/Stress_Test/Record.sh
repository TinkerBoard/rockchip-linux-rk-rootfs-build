...
if [ "$?" == "0" ]; then
	...
	media-ctl -d /dev/media0 --set-v4l2 '"m00_b_imx219 2-0010":0[fmt:SRGGB10_1X10/1920x1080]'
	...
	media-ctl -d /dev/media0 --set-v4l2 '"m00_b_ov5647 2-0036":0[fmt:SBGGR8_1X8/1296x972]'
