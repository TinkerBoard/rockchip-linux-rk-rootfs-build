...
pip3 install h5py
wget https://github.com/rockchip-linux/rknn-toolkit/releases/download/v1.4.0/rknn-toolkit-v1.4.0-packages.zip
unzip ./rknn-toolkit-v1.4.0-packages.zip
...
pip3 install ./packages/rknn_toolkit-1.4.0-cp35-cp35m-linux_aarch64.whl --user
