...
if [ "$VERSION" == "release" ]; then
	...
	sudo cp -rf overlay-debug/home/linaro/Desktop/install-rknn-toolkit-v1.3.2.sh $TARGET_ROOTFS_DIR/home/linaro/Desktop/install-rknn-toolkit-v1.3.2.sh
fi
...
if [ "$VERSION" == "release" ]; then
	...
	chmod a+x /home/linaro/Desktop/install-rknn-toolkit-v1.3.2.sh
fi
